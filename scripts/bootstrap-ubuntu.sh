...
PROXY_BYPASS_FEED_URLS="${PROXY_BYPASS_FEED_URLS:-}"
RKN_BLACKLIST_FEED_URLS="${RKN_BLACKLIST_FEED_URLS:-}"
PROXY_BYPASS_SYNC_ENABLED="${PROXY_BYPASS_SYNC_ENABLED:-1}"
RKN_BLACKLIST_SYNC_ENABLED="${RKN_BLACKLIST_SYNC_ENABLED:-1}"
PROXY_BYPASS_SYNC_MODE="${PROXY_BYPASS_SYNC_MODE:-merge}"
RKN_BLACKLIST_SYNC_MODE="${RKN_BLACKLIST_SYNC_MODE:-merge}"
PROXY_BYPASS_PRESERVE_FORCE_VPN_ON_REPLACE="${PROXY_BYPASS_PRESERVE_FORCE_VPN_ON_REPLACE:-1}"
LIST_SYNC_HTTP_TIMEOUT_SECONDS="${LIST_SYNC_HTTP_TIMEOUT_SECONDS:-20}"
LIST_SYNC_MAX_ITEMS="${LIST_SYNC_MAX_ITEMS:-15000}"
LIST_SYNC_STRICT="${LIST_SYNC_STRICT:-0}"
...
ENABLE_LIST_SYNC_TIMER="${ENABLE_LIST_SYNC_TIMER:-1}"
LIST_SYNC_ON_CALENDAR="${LIST_SYNC_ON_CALENDAR:-*:0/30}"
...
PROXY_BYPASS_FEED_URLS=${PROXY_BYPASS_FEED_URLS}
RKN_BLACKLIST_FEED_URLS=${RKN_BLACKLIST_FEED_URLS}
PROXY_BYPASS_SYNC_ENABLED=${PROXY_BYPASS_SYNC_ENABLED}
RKN_BLACKLIST_SYNC_ENABLED=${RKN_BLACKLIST_SYNC_ENABLED}
PROXY_BYPASS_SYNC_MODE=${PROXY_BYPASS_SYNC_MODE}
RKN_BLACKLIST_SYNC_MODE=${RKN_BLACKLIST_SYNC_MODE}
PROXY_BYPASS_PRESERVE_FORCE_VPN_ON_REPLACE=${PROXY_BYPASS_PRESERVE_FORCE_VPN_ON_REPLACE}
LIST_SYNC_HTTP_TIMEOUT_SECONDS=${LIST_SYNC_HTTP_TIMEOUT_SECONDS}
LIST_SYNC_MAX_ITEMS=${LIST_SYNC_MAX_ITEMS}
LIST_SYNC_STRICT=${LIST_SYNC_STRICT}
ADMIN_USERNAME=${ADMIN_USERNAME}
ADMIN_EMAIL=${ADMIN_EMAIL}
APP_SECRET_KEY_FILE=${APP_SECRET_KEY_FILE}
ADMIN_PASSWORD_FILE=${ADMIN_PASSWORD_FILE}
...
if [ "${ENABLE_LIST_SYNC_TIMER}" = "1" ] && [ -x "${DEPLOY_PATH}/scripts/setup-list-sync.sh" ]; then
  log "[10.7/12] Enable dynamic whitelist/blacklist sync timer..."
  DEPLOY_PATH="${DEPLOY_PATH}" RUN_USER="${TARGET_USER}" ON_CALENDAR="${LIST_SYNC_ON_CALENDAR}" \
    bash "${DEPLOY_PATH}/scripts/setup-list-sync.sh" || true
fi
